...
<head>
  ...
  <title>LMS BK SMANEGA | ADMIN | Dashboard</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="X_IPA_I" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>10 IPA 1</p>
                </a>
              </li> 
            <li class="nav-item">
                <a href="X_IPA_II" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>10 IPA 2</p>
                </a>
              </li> 
              <li class="nav-item">
                <a href="X_IPA_III" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>10 IPA 3</p>
                </a>
              </li>   
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="sepuluh_ipa_satu" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>11 IPA 1</p>
                </a>
              </li> 
    ...
    <section class="content">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  To Do List (Tulis Tugas Harian Yang Anda Kerjakan)
                </h3>
      ...
      <div class="card bg-gradient-success">
            ...
            <div class="card bg-gradient-primary">
              ...
              <div class="card-body">
                <div id="world-map" style="height: 100px; width: 400px;"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3950.215425438959!2d112.23831215068898!3d-8.079498894154394!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e78eccd228d3eb9%3A0x7f26e307334aa3f6!2sSMAN%201%20Garum!5e0!3m2!1sid!2sid!4v1665240486465!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
              </div>
              <!-- /.card-body-->
