      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"> Cari data dengan nama atau NIK</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            ...
            <thead>
                    <tr>
                      ...
                      <th style="width: 150px">AGAMA</th>
                      <th style="width: 40px">NO HP</th>
                    ...
                    <tr>
                      ...
                      <td>{{$item->agama_wali}}</td>
                      <td>{{$item->no_hp}}</td>
                      <td>{{$item->alamat_wali}}</td>
                      
                      <td> 
                        <a href ="{{ url('wali/'.$item->nik_wali.'/edit') }}">
                      <button type="submit" class="badge bg-primary">EDIT</button></a>
                      
                        <form action="{{ url('wali/'.$item->nik_wali) }}" method="POST">
                        @method('delete')
                        @csrf
