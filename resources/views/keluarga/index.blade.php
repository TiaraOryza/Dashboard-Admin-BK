  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Orang Tua Siswa</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<section class="content">
  <div class="container-fluid">
      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"> Tampilan Data Ayah</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            ...
            <thead>
                    ...
                    <tr>
                      ...
                      <td> 
                        <a href ="{{ url('keluarga/'.$item->no_kk.'/edit') }}">
                      <button type="submit" class="badge bg-primary">EDIT</button></a>
                      
                        <form action="{{ url('keluarga/'.$item->no_kk) }}" method="POST">
                        @method('delete')
                        @csrf
    ...
    <div class="card">
          <div class="card-header">
            <h3 class="card-title"> Tampilan Data Ibu</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
